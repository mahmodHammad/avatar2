...
export default {
    skin1:{
      ...
      beard:{
        regularMustache:{
          black:require("./all/beard/FC01_Black_Skin01.png").default,
          blonde:require("./all/beard/FC01_Blonde_Skin01.png").default,
          brown:require("./all/beard/FC01_Brown_Skin01.png").default,
        },
        curlyMustache:{
          black:require("./all/beard/FC02_Black_Skin01.png").default,
          blonde:require("./all/beard/FC02_Blonde_Skin01.png").default,
          brown:require("./all/beard/FC02_Brown_Skin01.png").default,
        },
        fullBeard:{
          black:require("./all/beard/FC03_Black_Skin01.png").default,
          blonde:require("./all/beard/FC03_Blonde_Skin01.png").default,
          brown:require("./all/beard/FC03_Brown_Skin01.png").default,
        },     
        shortBeard:{
          black:require("./all/beard/FC04_Black_Skin01.png").default,
          blonde:require("./all/beard/FC04_Blonde_Skin01.png").default,
          brown:require("./all/beard/FC04_Brown_Skin01.png").default,
        },    
        Goatee:{
      ...
      eyebrow:{
        slanted:require("./all/eyebrows/EYEBROWS_01_Skin_01.png").default,
